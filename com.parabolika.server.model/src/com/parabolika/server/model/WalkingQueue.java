...
import com.parabolika.server.model.util.ModelConstants;
import com.parabolika.server.model.util.ModelHelpers;
...
public class WalkingQueue {
	...
	private void addStepInternal(int x, int y) {
		 ...
		 */
		int dir = ModelHelpers.direction(diffX, diffY);
	...
	private Point getNextPoint() {
		...
		if(p == null || p.dir == -1) {
			 ...
			 */
			int diffX = ModelConstants.DIRECTION_DELTA_X[p.dir];
			int diffY = ModelConstants.DIRECTION_DELTA_Y[p.dir];
